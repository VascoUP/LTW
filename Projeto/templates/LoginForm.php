...
<div hidden id="login-form">
	<img id="login-profile-picture" alt="Profile Picture" src="images/no-user-image.jpg">
	<form class="class_form" id="login_form" onsubmit="return validateLogin()" method="POST" action="action_login.php">
